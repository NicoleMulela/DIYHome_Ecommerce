...
$qry="SELECT * FROM users WHERE UserEmail='$ue' AND UserRole='seller'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    $url=("../auth/sellerregistration.php");
    header("location: $url");
}else{
    //create new user
    $qry=" INSERT INTO users(UserName,UserEmail,UserRole,UserPassword) VALUES ('$un','$ue', 'seller','$pwd')";
