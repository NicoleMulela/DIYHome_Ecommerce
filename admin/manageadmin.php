...
<main style="margin-top: 25px;">
  <div class="container pt-4">
    ...
    <?php endif; ?>
    <<?php
    //Fetch users table where role is admin except active admins
    $id=$_SESSION['UserID'];
    $sql= "SELECT * FROM users WHERE UserRole='admin' AND UserID!='$id'";
  ...
  <h1>Manage Admin</h1>
    <div>
        ...
        <a href="registeradmin.php" class="btn btn-secondary"> Create New Admin</a>
    </div>
